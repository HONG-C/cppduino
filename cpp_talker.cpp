...
int main(int argc, char **argv)                 // Node Main Function
{
  ...
  ros::Publisher cppduino_pub = nh.advertise<cppduino::MsgTutorial>("ros_tutorial_msg", 100);

  // Set the loop period. '10' refers to 10 Hz and the main loop repeats at 0.1 second intervals
  ros::Rate loop_rate(10);

  cppduino::MsgTutorial msg;     // Declares message 'msg' in 'MsgTutorial' message file format
